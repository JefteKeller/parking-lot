...
class TestAccountView(TestCase):
    ...
    def test_create_account_and_login(self):
        user = self.client.post("/api/accounts/",
                                self.admin_data,
                                format="json").json()
...
class TestInfrastructureView(TestCase):
    ...
    def test_admin_create_level(self):
        ...
        level = client.post("/api/levels/", self.level_data,
                            format="json").json()
    ...
    def test_get_level_info(self):
        ...
        for i, level in enumerate(levels):
            ...
            self.assertEqual(
                level["available_spaces"]["available_motorcycle_spaces"], 1)
            self.assertEqual(level["available_spaces"]["available_car_spaces"],
                             2)
    ...
    def test_admin_create_pricing(self):
        ...
        pricing = client.post("/api/pricings/",
                              self.pricing_data,
                              format="json").json()
    ...
    def test_only_admin_can_create_pricing(self):
        ...
        response = client.post("/api/pricings/",
                               self.pricing_data,
                               format="json")
...
class TestVehicleView(TestCase):
    ...
    def test_cars_and_motorcycles_take_different_spaces(self):
        ...
        level = client.post("/api/levels/", self.level_data_all,
                            format="json").json()
        ...
        # only one parking space left
        level = client.get("/api/levels/").json()[0]
        available_car_spaces = level["available_spaces"][
            "available_car_spaces"]
        ...
        motorcycle = client.post("/api/vehicles/",
                                 self.motorcycle_data,
                                 format="json").json()
    ...
    def test_spaces_are_filled_by_priority(self):
        ...
        self.assertEqual(level_1["available_spaces"]["available_car_spaces"],
                         0)
        self.assertEqual(level_2["available_spaces"]["available_car_spaces"],
                         10)
